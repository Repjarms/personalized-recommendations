...
## Deploy this sample application in Bluemix
  ...
  [![Deploy to Bluemix](https://bluemix.net/deploy/button.png)](<a href="https://bluemix.net/deploy?repository=https://github.com/repjarms/personalized-recommendations" target=_blank>example</a>)
